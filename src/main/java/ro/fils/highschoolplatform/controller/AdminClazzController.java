...
public class AdminClazzController {
    ...
    public @ResponseBody
    void update(
            @RequestParam(value = "classId", required = false) String classId, @RequestParam(value = "courseId", required = false) String courseId, @RequestParam(value = "profId", required = false) String profId) {
